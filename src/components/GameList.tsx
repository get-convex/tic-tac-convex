...
export function GameList({
  ...
  const GameCard = ({ game }: { game: GameListProps["games"][0] }) => {
    const players = useQuery(api.players.getMultiple, { ids: game.players })
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800">
            Welcome, <span className="text-indigo-600">{currentPlayer.name}</span>!
          </h1>
